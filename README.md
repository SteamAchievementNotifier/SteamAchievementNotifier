...
**INSTALLATION:**
1. Download **[SteamAchievementNotifier_1.85.5_x64-setup.exe](https://github.com/SteamAchievementNotifier/SteamAchievementNotifier/releases/download/1.85/SteamAchievementNotifier_1.85.5_x64-setup.exe)** (or download from the [Releases](https://github.com/SteamAchievementNotifier/SteamAchievementNotifier/releases) page).
