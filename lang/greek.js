...
document.getElementById("typegame").innerHTML = "Παιχνίδι Τέχνη"
document.getElementById("brightnesslbl").innerHTML = "ΛΑΜΨΗ"
...
document.getElementById("typegamerare").innerHTML = "Παιχνίδι Τέχνη"
document.getElementById("brightnesslblrare").innerHTML = "ΛΑΜΨΗ"
...
document.getElementById("notifydebuglbl").innerHTML = "Εμφάνιση Κονσόλας Ειδοποιήσεων"