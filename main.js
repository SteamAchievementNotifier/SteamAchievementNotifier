...
function createWindow() {
   win = new BrowserWindow({
      ...
      frame: false,
      center: true,
      title: "Steam Achievement Notifier (V1.72)",
...
app.whenReady().then(function() {
   ...
   /*try {
      JSON.parse(fs.readFileSync(path.join(process.env.LOCALAPPDATA,"Steam Achievement Notifier (V1.7)","store","config.json")));
      ...
      console.log("\"Config.json\" does not exist. Setting tray language to \"English\".");
   ...
   tray.setToolTip("Steam Achievement Notifier (V1.72)");
