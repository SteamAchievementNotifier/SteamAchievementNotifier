...
function RemoveApp() {
    console.log("%cStep 1: BACKUP...", "color: deepskyblue; font-family: 'Bahnschrift'");
    ...
    try {
        ...
        console.log("%cSteam Achievement Notifier config backed up", "color: seagreen; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nSteam Achievement Notifier config backed up");
    } catch {
        console.log("%cError backing up Steam Achievement Notifier config", "color: red; font-family: 'Bahnschrift'")
    ...
    try {
        ...
        console.log("%cSteam Achievement Notifier logo backed up", "color: seagreen; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nSteam Achievement Notifier logo backed up");
    } catch {
        console.log("%cError backing up Steam Achievement Notifier logo", "color: red; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nError backing up Steam Achievement Notifier logo");
    }
    console.log("%cStep 2: DELETING FILES...", "color: deepskyblue; font-family: 'Bahnschrift'")
    ...
    try {
        ...
        console.log("%cError deleting \"Steam Achievement Notifier (V1.8)\" directory in %localappdata%", "color: red; font-family: 'Bahnschrift'")
    ...
    try {
        ...
        console.log("%cStart Menu shortcut deleted.", "color: seagreen; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nStart Menu shortcut deleted.");
    } catch {
        console.log("%cError deleting Start Menu shortcut", "color: red; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nError deleting Start Menu shortcut");
    }
    try {
        fs.rmSync(path.join(os.homedir(),"Desktop","Steam Achievement Notifier (V" + thisver + ").lnk"));
        console.log("%cDesktop shortcut deleted.", "color: seagreen; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nDesktop shortcut deleted.");
    } catch {
        console.log("%cError deleting Desktop shortcut", "color: red; font-family: 'Bahnschrift'")
    ...
    try {
        ...
        console.log("%cStartup shortcut deleted.", "color: seagreen; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nStartup shortcut deleted.");
    } catch {
        console.log("%cError deleting Startup shortcut", "color: red; font-family: 'Bahnschrift'")
        fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nError deleting Startup shortcut");
    }
    console.log("%cReset: COMPLETE", "color: deepskyblue; font-family: 'Bahnschrift'")
    fs.appendFileSync(path.join(process.env.LOCALAPPDATA,"Temp","sanresetlog.txt"), "\r\nReset: COMPLETE");
}
...
function TestNotification() {
    ...
    console.log("%cMain Test Notification added to queue.", "color: lightskyblue; font-family: 'Bahnschrift'");
    ...
    function CheckIfRunning() {
        if (running == true) {
            ...
            ipcRenderer.once('notrunning', function() {
                running = false;
                if (queue.length == 0) {
                    console.log("%cQueue is empty.", "font-family: 'Bahnschrift'");
                } else {
                    console.log("%cQueue Position: " + queue.length, "font-family: 'Bahnschrift'");
                }
            });
        }
    }
...
function TestRareNotification() {
    ...
    console.log("%cRare Test Notification added to queue.", "color: darkorchid; font-family: 'Bahnschrift'");
    ...
    function CheckIfRunning() {
        if (running == true) {
            ...
            ipcRenderer.once('notrunning', function() {
                running = false;
                if (queue.length == 0) {
                    console.log("%cQueue is empty.", "color: grey; font-family: 'Bahnschrift'")
                } else {
                    console.log("%cQueue Position: " + queue.length, "color: grey; font-family: 'Bahnschrift'");
                }
            });
        }
    }
...
function GetSteam3ID() {
    regkey.list([`HKCU\\SOFTWARE\\Valve\\Steam\\ActiveProcess`], function(err, result) {
        try {
            ...
            // console.log("%cSteam3ID not found", "color: red; font-family: 'Bahnschrift'");
        }
    });
}
...
function GetSteamPath() {
    regkey.list([`HKCU\\SOFTWARE\\Valve\\Steam\\`], function(err, result) {
        try {
            ...
            // console.log("%cSteam installation path not found", "color: red; font-family: 'Bahnschrift'");
        }
    });
}
...
function SANIdle() {
    GetSteam3ID();
    console.log("%cSteam3ID (For user logged into Steam client): " + steam3id, "color: seagreen; font-family: 'Bahnschrift'");
    GetSteamPath();
    console.log("%cSteam installation path: " + steampath, "color: seagreen; font-family: 'Bahnschrift'");
    ...
    var sanidle = setInterval(function() {
        ...
        if (appid == 0 || appid == undefined) {
            console.log("%cNo game detected", "color: darkred; font-family: 'Bahnschrift'");
        } else {
            regkey.list([`HKCU\\SOFTWARE\\Valve\\Steam\\Apps\\${appid}`], function(err, result) {
                ...
                console.log("%cNow tracking achievements for: " + gamename, "color: deepskyblue; font-family: 'Bahnschrift'");
                document.getElementById("gamestatus").style.color = "white";
                document.getElementById("gamestatus").innerHTML = gamename;
                ipcRenderer.send('track', gamename, trayshow, trayexit);
            });
...
function CheckAchievements() {
    return new Promise((resolve, reject) => {
        ...
        fetch(ggapfa).then(response => response.json()).then((data) => {
            ...
            if (cheevnum !== 0) {
                console.log(`%cAppID ${appid} has achievements (${cheevnum})`, "color: limegreen; font-family: 'Bahnschrift'");
                resolve();
            } else {
                console.log(`%cAppID ${appid} has no achievements (${cheevnum})`, "color: red; font-family: 'Bahnschrift'");
                reject();
            }
        }).catch(() => {
            if (appid !== 0) {
                console.log(`%cAppID ${appid} has no achievements (No API response received)`, "color: orange; font-family: 'Bahnschrift'");
            }
            reject();
        });
    });
...
async function StartSAN() {
    try {
        ...
        //     if (cheevnum !== 0) {
        //         console.log(`%cAppID ${appid} has achievements (${cheevnum})`, "color: green; font-family: 'Bahnschrift'");
        //         // CheckCompletion();
        //     } else {
        //         console.log(`%cAppID ${appid} has no achievements (${cheevnum})`, "color: red; font-family: 'Bahnschrift'");
        //     }
        ...
        function GetAchievementsFromURL() {
            ...
            fetch(gpa).then(response => response.json()).then((data) => {
                ...
                function MainNotification(t, d, i) {
                    ...
                    console.log("%cMain Notification added to queue.", "color: lightskyblue; font-family: 'Bahnschrift'");
                ...
                function RareNotification(t, d, i) {
                    ...
                    console.log("%cRare Notification added to queue.", "color: darkorchid; font-family: 'Bahnschrift'");
        ...
        console.log(`%cTracking changes to file: ${steampath}/appcache/stats/UserGameStats_${steam3id}_${appid}.bin`, "color: seagreen; font-family: 'Bahnschrift'");
            ...
            if (appid == 0 || appid == undefined || appid !== currgame) {
                ...
                fs.stat(`${steampath}/appcache/stats/UserGameStats_${steam3id}_${appid}.bin`, function(err, stats) {
                    if (stats.mtime > lastmodified) {
                        console.log("%cFile was changed!", "color: deepskyblue; font-family: 'Bahnschrift'");
                        lastmodified = stats.mtime;
        ...
        // console.log("%cStartSAN() not running", "color: red; font-family: 'Bahnschrift'");
    ...
    function SetSkinInReg() {
        ...
        regkey.putValue(skinv5value, function(err) {
            if (err) {
                ...
                console.log("%cNoSteamNotifications Steam skin set in Registry.", "color: seagreen; font-family: 'Bahnschrift'");
                RestartSteam();
            }
        });
    }
    ...
    function RemoveSkinInReg() {
        ...
        regkey.putValue(skinv5value, function(err) {
            if (err) {
                ...
                console.log("%cDefault Steam skin set in Registry.", "color: seagreen; font-family: 'Bahnschrift'");
                RestartSteam();
            }
        });
    }
            ...
            var checkprocesses = setInterval(function() {
                exec("tasklist", function(err, process) {
                    ...
                    if (steamrecheck !== -1) {
                        ...
                        console.log("%cSteam is NOT running", "font-family: 'Bahnschrift'; color: red");
                    }
                });
            }, 2000);
        } else {
            console.log("%cSteam is running.", "font-family: 'Bahnschrift'; color: cyan");
        }
    });
}
...
function GameCompletionNotification() {
    ...
    console.log("%cGame Completion Notification added to queue.", "color: yellow; font-family: 'Bahnschrift'");
    ...
    if (fs.existsSync(statsfile)) {
        ...
        if (appid !== 0 && appid !== undefined) {
            if (appid in currstats.mapCache) {
                ...
                console.log("%cStats file exists and AppID located in " + statsfile, "color: green; font-family: 'Bahnschrift'");
                ...
                if (currentvalue == true) {
                    console.log("%cGame already complete!", "color: yellow; font-family: 'Bahnschrift'");
                // If "all_unlocked" is false, check for changes every second until appid == 0 or undefined
                } else {
                    console.log("%cGame is not complete yet! Checking for completion...", "color: yellow; font-family: 'Bahnschrift'");
                    var checkprogress = setInterval(function() {
                        if (appid == 0 || appid == undefined) {
                            ...
                            fs.stat(statsfile, function(err, stats) {
                                if (stats.mtime > lastmodified) {
                                    console.log("%cAchievement Progress File was changed!", "color: deepskyblue; font-family: 'Bahnschrift'");
                                    lastmodified = stats.mtime;
                ...
                console.log("%cStats file exists but AppID not found!", "color: orange; font-family: 'Bahnschrift'");
                ...
                var checkappid = setInterval(function() {
                    ...
                    if (appid == 0 || appid == undefined) {
                        ...
                        if (appid in newstats.mapCache) {
                            clearInterval(checkappid)
                            console.log("%cAppID found in " + statsfile + "!", "color: green; font-family: 'Bahnschrift'");
                            CheckCompletion();
                        } else {
                            console.log("%cAppID not found in " + statsfile, "color: red; font-family: 'Bahnschrift'");
                        }   
                    }
                }, 1000);
            }
        ...
        var checkstatsfile = setInterval(function() {
            if (appid == 0 || appid == undefined) {
                ...
                if (fs.existsSync(statsfile)) {
                    clearInterval(checkstatsfile);
                    console.log("%cStats file found at " + statsfile, "color: green; font-family: 'Bahnschrift'");
                    CheckCompletion();
                } else {
...
ipcRenderer.on('secondinstance', () => {
    console.log("%cSecond instance detected %c- showing main window...", "color: lightskyblue; font-family: 'Bahnschrift'", "color: white; font-family: 'Bahnschrift'");
});
