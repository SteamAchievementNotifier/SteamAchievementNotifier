    ...
    if (winlbl === "main") {
        ...
        const translations = {
            ...
            extwin: {
                ...
                tt: `Uma janela externa que duplica todas as notificações. Pode ser capturada por software de streaming/captura de tela.<div class="ttwarn">Esta janela é <u>totalmente transparente</u>. Para destacar a posição atual da janela, segure a tecla <span class="ttcode">Ctrl</span>.</div>`,
                query: ".sanboxlbl"
            },
            track: {
            ...
            scbtn: {
                tt: "Definir um atalho para acionar uma Notificação de Teste para este tipo"
            },
            sctabmain: {
                tt: "Atalho de Notificação Principal"
            },
            sctabrare: {
                tt: "Atalho de Notificação Rara"
            },
            sctabplat: {
