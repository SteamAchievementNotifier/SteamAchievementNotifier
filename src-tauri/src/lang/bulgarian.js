    ...
    if (winlbl === "main") {
        ...
        const translations = {
            ...
            extwin: {
                ...
                tt: `Външно прозорец, който дублира всички уведомления. Може да бъде насочен от софтуер за стрийминг / запис на екрана.<div class="ttwarn">Този прозорец е <u>пълно прозрачен</u>. За да маркирате текущото положение на прозореца, задръжте клавиша <span class="ttcode">Ctrl</span>.</div>`,
                query: ".sanboxlbl"
            },
            track: {
            ...
            shortcuts: {
                elem: "Преки пътища",
                tt: "Задайте клавишна комбинация, за да активирате тестови известия",
                query: ".sanboxlbl"
            },
            scbtn: {
                tt: "Задайте преки пътища, за да активирате тестови известия за този тип"
            },
            sctabmain: {
                tt: "Основен преки път за известия"
            },
            sctabrare: {
                tt: "Рядък преки път за известия"
            },
            sctabplat: {
                tt: "100% преки път за известия"
            },
            screenshotmode: {
            ...
            fontdeletebtn: {
                tt: "Възстановяване на стандартния шрифт"
            },
            style: {
                elem: "Стил",
                query: `.sanboxtitle > label`
