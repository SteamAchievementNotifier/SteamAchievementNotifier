    ...
    if (winlbl === "main") {
        ...
        const translations = {
            ...
            extwin: {
                ...
                tt: "Διπλότυπες ειδοποιήσεις σε εξωτερικό παράθυρο",
                query: ".sanboxlbl"
            },
            statwin: {
                elem: "Εμφάνιση στατιστικών επιτευγμάτων",
                tt: "Εμφάνιση παραθύρου στατιστικών επιτευγμάτων",
                query: ".sanboxlbl"
            },
            track: {
