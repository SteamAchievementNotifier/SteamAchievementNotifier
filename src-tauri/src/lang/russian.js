    ...
    if (winlbl === "main") {
        ...
        const translations = {
            ...
            extwin: {
                ...
                tt: `Внешнее окно, дублирующее все уведомления. Может быть запущено программой для стриминга/захвата экрана.<div class="ttwarn">Это окно полностью <u>прозрачное</u>. Чтобы выделить текущее положение окна, удерживайте клавишу <span class="ttcode">Ctrl</span>.</div>`,
                query: ".sanboxlbl"
            },
            track: {
            ...
            shortcuts: {
                elem: "Ярлыки уведомлений",
                tt: "Установите сочетание клавиш для запуска тестовых уведомлений",
                query: ".sanboxlbl"
            },
            scbtn: {
                tt: "Установите ярлык для запуска тестового уведомления этого типа"
            },
            sctabmain: {
                tt: "Основной ярлык уведомления"
            },
            sctabrare: {
                tt: "Редкий ярлык уведомления"
            },
            sctabplat: {
                tt: "Ярлык уведомления 100%"
            },
            screenshotmode: {
            ...
            fontdeletebtn: {
                tt: "Сбросить на шрифт по умолчанию"
            },
            style: {
                elem: "Стиль",
                query: `.sanboxtitle > label`
