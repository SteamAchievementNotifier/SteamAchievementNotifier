    ...
    if (winlbl === "main") {
        ...
        const translations = {
            ...
            extwin: {
                ...
                tt: `Una ventana externa que duplica todas las notificaciones. Puede ser objetivo de software de transmisión/captura de pantalla.<div class="ttwarn">Esta ventana es <u>totalmente transparente</u>. Para resaltar la posición actual de la ventana, mantén presionada la tecla <span class="ttcode">Ctrl</span>.</div>`,
                query: ".sanboxlbl"
            },
            track: {
            ...
            filesystem: {
                elem: "Carga de Archivos",
                tt: `Cargar archivos de notificación y activos desde el directorio ejecutable de la aplicación, en lugar de internamente`,
                query: ".sanboxlbl"
            },
            ppbtn: {
            ...
            customfont: {
                elem: "Fuente",
                tt: "Cargue un archivo de fuente personalizada para aplicar a todos los elementos de texto dentro de la notificación",
                query: ".sanboxlbl"
            },
            fontdeletebtn: {
                tt: "Restablecer a fuente predeterminada"
            },
            style: {
                elem: "Estilo",
                query: `.sanboxtitle > label`
            ...
            nofont: "Ninguna Fuente",
            fontselectdialog: "Seleccionar Archivo de Fuente"
        }
