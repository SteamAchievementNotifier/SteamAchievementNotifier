    ...
    if (winlbl === "main") {
        ...
        const translations = {
            ...
            extwin: {
                ...
                tt: `หน้าต่างภายนอกที่ทำซ้ำการแจ้งเตือนทั้งหมด สามารถเป็นเป้าหมายของซอฟต์แวร์สตรีมมิ่ง/บันทึกหน้าจอ<div class="ttwarn">หน้าต่างนี้เป็น<u>โปร่งใสแบบเต็มรูปแบบ</u> ในการเน้นตำแหน่งปัจจุบันของหน้าต่าง ให้กดค้างที่ปุ่ม <span class="ttcode">Ctrl</span></div>`,
                query: ".sanboxlbl"
            },
            track: {
            ...
            filesystem: {
                elem: "การโหลดไฟล์",
                tt: `โหลดไฟล์แจ้งเตือนและทรัพยากรจากไดเรกทอรีการดำเนินการของแอปพลิเคชันแทนที่จะดำเนินการภายใน`,
                query: ".sanboxlbl"
            },
            ppbtn: {
