export const translations = {
    ...
    settings: {
        ...
        advanced: {
            ...
            content: {
                ...
                workerdebug: "إظهار أدوات المطور الخاصة بالـ Worker",
    ...
    tooltips: {
        ...
        workerdebug: "إنشاء نافذة أدوات المطور لعملية الـ Worker. مفيد لتصحيح الأخطاء واستكشاف مشكلات تتبع الألعاب وإصلاحها",
        ...
        raui: `اعرض أسماء ألعاب RetroAchievements المكتشفة في واجهة عرض اللعبة/واجهة درج النظام<br><br><span class="ttdesc">عند التمكين، قد يحدث سلوك غير متوقع في واجهة عرض اللعبة/واجهة درج النظام إذا كانت ألعاب Steam وRetroAchievements قيد التشغيل في الوقت نفسه</span>`
    },
    update: {
