export const translations = {
    ...
    tooltips: {
        ...
        webhooktypesmain: `تبديل ما إذا كنت تريد نشر معلومات الإنجازات إلى خادم Discord عند فتح إنجاز رئيسي`,
        webhooktypesrare: "تبديل ما إذا كنت تريد نشر معلومات الإنجازات إلى خادم Discord عند فتح إنجاز نادر",
        webhooktypesplat: "تبديل ما إذا كنت تريد نشر معلومات الإنجازات إلى خادم Discord عند فتح إنجاز 100%",
