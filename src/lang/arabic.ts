export const translations = {
    ...
    settings: {
        ...
        streaming: {
            ...
            content: {
                ...
                gametimerwin: "مؤقت إكمال اللعبة",
                gametimerwinshortcut: "اختصار المؤقت",
                gametimerwinaot: "دائمًا في المقدمة",
                resetgametimer: "إعادة تعيين المؤقت",
                resetgametimersub: `
                    <div class="wrapper resetsub">
                        <span>هل أنت متأكد؟</span>
                        <span>سيؤدي هذا إلى إعادة تعيين مؤقت إكمال اللعبة للعبة الحالية إلى 00:00:00.000.</span>
                        <span class="noundo">🛑 لا يمكن التراجع عن هذا!</span>
                    </div>
                `,
        ...
        accessibility: {
            ...
            content: {
                ...
                noshortcuts: "تعطيل اختصارات لوحة المفاتيح"
            }
        },
        advanced: {
            title: "متقدم",
            content: {
                ...
                appdatadir: "عرض مجلد AppData",
                backup: "نسخ احتياطي",
                backuppath: "مسار النسخ الاحتياطي",
                backupsub: [
                    "نسخ محتويات مجلد AppData الخاص بالتطبيق إلى موقع تختاره",
                    "سيكون هذا النسخ الاحتياطي نقطة استعادة للحالة الحالية للتطبيق",
                    `استعادة أي نسخة احتياطية سابقة عبر <span class="hl">الإعدادات</span> > <span class="hl">متقدم</span> > <span class="hl">استعادة</span>`
                ],
                backupfailed: "تعذر إنشاء النسخ الاحتياطي.",
                restore: "استعادة",
                restoresub: [
                    "استعادة محتويات مجلد AppData الخاص بالتطبيق من نسخة احتياطية سابقة",
                    `اختر ملف نسخة احتياطية <span class="hl">.sanbak</span> للاستعادة منه. سيتم الاحتفاظ بهذا الملف بعد اكتمال الاستعادة`,
                    "❗ بعد التأكيد، سيعيد التطبيق التشغيل لاستعادة ملف النسخة الاحتياطية المحدد"
                ],
    ...
    tooltips: {
        ...
        appdatadir: "فتح موقع مجلد AppData الخاص بالتطبيق",
        backup: "نسخ محتويات مجلد AppData الخاص بالتطبيق إلى موقع تختاره، والذي سيكون بمثابة نقطة استعادة للحالة الحالية للتطبيق",
        restore: "استعادة محتويات مجلد AppData الخاص بالتطبيق من نسخة احتياطية سابقة",
        gametimerwin: "عرض مؤقت على الشاشة يوضح مقدار الوقت المستغرق لفتح جميع الإنجازات الخاصة باللعبة الحالية",
        gametimerwinshortcut: "تبديل مؤقت إكمال اللعبة باستخدام اختصار لوحة المفاتيح المحدد",
        gametimerwinaot: `تعيين مؤقت إكمال اللعبة إلى وضع "دائمًا في المقدمة"، مما يسمح بعرض النافذة فوق نافذة اللعبة<br><br><span class="ttdesc">عند التفعيل، لن يسجل مؤقت إكمال اللعبة تفاعلات المستخدم، مثل أحداث "النقر". لإعادة تفعيل التفاعل مع النافذة، يجب تعطيل هذا الخيار</span>`,
        resetgametimer: "إعادة تعيين مؤقت إكمال اللعبة للعبة الحالية",
