export const translations = {
    global: {
        ...
        raenablelog: `Разрешаване на лог файлове на емулатора`,
        raenablelogsub: [
            `За да получите достъп до вътрешни събития на поддържаните емулатори (като текущо състояние на играта, информация за отключени постижения и др.), <span class="hl">лог файловете</span> трябва да бъдат активирани във всеки избран емулатор.<br><br>Всеки лог файл ще се намира в папката <span class="hl">Logs</span> в указаната директория за съответния емулатор.`,
            `<span class="hl">RetroArch</span>: Отидете в <i class="hllb">Настройки > Логове</i> и задайте <i><span class="hllb">Детайлност на логовете</span>: <span class="hlgreen">ВКЛ.</span>, <span class="hllb">Ниво на логване на интерфейса</span>: <span class="hlgreen">1 (Информация)</span></i> и <i><span class="hllb">Лог във файл</span>: <span class="hlgreen">ВКЛ.</span></i>`,
            `<span class="hl">Dolphin</span>: Отидете в <i class="hllb">Изглед > Показване на настройките за логове</i> и задайте <i><span class="hllb">Детайлност</span>: <span class="hlgreen">Информация</span>, <span class="hllb">Изходи на логовете</span> > <span class="hlgreen">Запис във файл</span></i> и <i><span class="hllb">Типове логове</span> > <span class="hlgreen">Постижения (RetroAchievements)</span></i>`,
            `<span class="hl">PCSX2</span>: Активирайте <i class="hllb">Инструменти > Разрешаване на логване във файл</i>`
        ]
    },
    app: {
        content: {
    ...
    settings: {
        ...
        ra: {
            ...
            content: {
                ...
                pcsx2: "PCSX2",
                ppspp: "PPSPP",
                installdir: "Път до данните",
                rapercenttype: "Тип на процента",
                hard: "Хардкор",
                soft: "Софткор",
                placeholder: "Въведете пътя за инсталация"
            }
        },
        misc: {
            title: "Разни",
    ...
    tooltips: {
        ...
        rakey: `Задайте Web API ключа за удостоверяване към Retro Achievements API<br><br><span class="ttdesc">Web API ключ може да бъде копиран или генериран отново, като влезете в уебсайта на Retro Achievements и отидете в Настройки > Ключове > Web API ключ<br><br>🔒 Въведеният ключ ще бъде криптиран преди да бъде съхранен локално в системата</span>`,
        rapercenttype: "Задайте дали да се показва процентът на отключените хардкор или софткор постижения в известията",
        retroarch: `Показване на известия за Retro Achievements за игри, емулирани чрез RetroArch<br><br><span class="ttdesc"><i class="hllb">RetroArch > Настройки > Регистрационни файлове</i> трябва да бъде конфигуриран със следните настройки:<br><br><ul><li><span class="hllb">Детайлност на регистрацията</span>: <span class="hlgreen">ВКЛ.</span></li><li><span class="hllb">Ниво на регистрация на интерфейса</span>: <span class="hlgreen">1 (Информация)</span></li><li><span class="hllb">Запис в файл</span>: <span class="hlgreen">ВКЛ.</span></li></ul></span>`,  
        dolphin: `Показване на известия за Retro Achievements за игри, емулирани чрез Dolphin<br><br><span class="ttdesc"><i class="hllb">Dolphin > Изглед > Показване на настройките за регистрация</i> трябва да бъде конфигуриран със следните настройки:<br><br><ul><li><span class="hllb">Детайлност</span>: <span class="hlgreen">Информация</span></li><li><span class="hllb">Изходи на регистрацията</span> > <span class="hlgreen">Запис във файл</span></li><li><span class="hllb">Типове регистрация</span> > <span class="hlgreen">Постижения (RetroAchievements)</span></li></ul></span>`,  
        pcsx2: `Показване на известия за Retro Achievements за игри, емулирани чрез PCSX2<br><br><span class="ttdesc"><i class="hllb">PCSX2 > Инструменти > Активиране на регистрация във файл</i> трябва да бъде активирано</span>`,  
        retroarchpath: `Задайте пътя до папката, съдържаща директорията "Logs" за RetroArch<br><br><span class="ttdesc">Данните на RetroArch се съхраняват в директорията за инсталация на приложението</span>`,  
        dolphinpath: `Задайте пътя до папката, съдържаща директорията "Logs" за Dolphin<br><br><span class="ttdesc">Данните на Dolphin се съхраняват на едно от следните места:<br><br><ul><li><span class="hllb">%APPDATA%\\Dolphin Emulator</span></li><li><span class="hllb">%USERPROFILE%\\Documents\\Dolphin Emulator</span></li><li>🐧 <span class="hllb">$XDG_DATA_HOME/dolphin-emu</span></li></ul></span>`,  
        pcsx2path: `Задайте пътя до папката, съдържаща директорията "Logs" за PCSX2<br><br><span class="ttdesc">Данните на PCSX2 се съхраняват в директорията за инсталация на приложението</span>`,  
    },
    update: {
