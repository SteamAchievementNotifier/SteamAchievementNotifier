export const translations = {
    ...
    tooltips: {
        ...
        rakey: `Задайте Web API ключа, който да се използва за удостоверяване в Retro Achievements API<br><br><span class="ttdesc">Web API ключ може да бъде копиран или регенериран, като влезете в уебсайта на Retro Achievements и отидете на <span class="hl">Настройки > Ключове > Web API Key</span><br><br>🔒 Предоставеният ключ ще бъде криптиран, преди да бъде съхранен локално в системата</span>`,
