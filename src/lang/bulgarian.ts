export const translations = {
    ...
    tooltips: {
        ...
        webhooktypesmain: `Превключване дали информацията за постижения да се публикува в Discord сървър при отключване на основно постижение`,
        webhooktypesrare: "Превключване дали информацията за постижения да се публикува в Discord сървър при отключване на рядко постижение",
        webhooktypesplat: "Превключване дали информацията за постижения да се публикува в Discord сървър при отключване на 100% постижение",
