export const translations = {
    ...
    settings: {
        ...
        advanced: {
            ...
            content: {
                ...
                uselegacynotifytimer: "Използвай стар таймер за известия",
    ...
    tooltips: {
        ...
        uselegacynotifytimer: `Скриване на известията чрез статичен таймер извън прозореца на известието<br><br><span class="ttdesc">Активирането на тази опция може да доведе до неуспешно завършване на анимациите на известията</span>`,
