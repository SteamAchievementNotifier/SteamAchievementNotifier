export const translations = {
    ...
    tooltips: {
        ...
        retroarchpath: `Задайте пътя до файла с дневник <span class="hl">"retroarch.log"</span> на RetroArch<br><br><span class="ttdesc">При стандартни настройки на инсталацията <span class="hl">"retroarch.log"</span> се съхранява в <span class="hllb">C:\\RetroArch-x64\\Logs</span></span>`,
