export const translations = {
    ...
    tooltips: {
        ...
        glowcolorbronze: "Цветът на сиянието, когато процентът на отключване е > 50%",
        glowcolorsilver: "Цветът на сиянието, когато процентът на отключване е < 50% и > $rarity",
        ...
        webhookmain: `Превключване дали информацията за постижения да се публикува в Discord сървър при отключване на основно постижение`,
        webhookrare: "Превключване дали информацията за постижения да се публикува в Discord сървър при отключване на рядко постижение",
        webhookplat: "Превключване дали информацията за постижения да се публикува в Discord сървър при отключване на 100% постижение",
        ...
        percentbadgeimgbronze: "Иконата за значка, която се показва, когато процентът на отключване е > 50%",
        sspercentbadgeimgbronze: "Иконата за значка, която се показва, когато процентът на отключване е > 50%",
        percentbadgeimgsilver: "Иконата за значка, която се показва, когато процентът на отключване е < 50% и > $rarity",
        sspercentbadgeimgsilver: "Иконата за значка, която се показва, когато процентът на отключване е < 50% и > $rarity",
        ...
        iconborderimgbronze: "Рамката на иконата, показвана когато процентът на отключване е > 50%",
        iconborderimgsilver: "Рамката на иконата, показвана когато процентът на отключване е < 50% и > $rarity",
        ...
        webhookembedcolormain: "Задаване на цвета, използван в вграденото известие в уебкука при отключване на основно постижение",
        webhookembedcolorrare: "Задаване на цвета, използван в вграденото известие в уебкука при отключване на рядко постижение",
        webhookembedcolorplat: "Задаване на цвета, използван в вграденото известие в уебкука при отключване на 100% постижение",
    ...
    notificationelems: {
        ...
        content: {
            ...
            percentbadgeimgbronze: "Редкост: > 50%",
            sspercentbadgeimgbronze: "Редкост: > 50%",
            percentbadgeimgsilver: "Редкост: < 50% и > $rarity%",
            sspercentbadgeimgsilver: "Редкост: < 50% и > $rarity%",
