export const translations = {
    ...
    tooltips: {
        ...
        retroarchpath: `Задайте пътя до файла с дневник <span class="hl">"retroarch.log"</span> на RetroArch<br><br><span class="ttdesc">При стандартни настройки на инсталацията <span class="hl">"retroarch.log"</span> се съхранява в <span class="hllb">%SYSTEMDRIVE%\\RetroArch-Win64\\Logs</span></span>`,
        dolphinpath: `Задайте пътя до файла с дневник <span class="hl">"dolphin.log"</span> на Dolphin<br><br><span class="ttdesc">При стандартни настройки на инсталацията <span class="hl">"dolphin.log"</span> се съхранява на едно от следните места:<br><br><ul><li><span class="hllb">%APPDATA%\\Dolphin Emulator\\Logs</span></li><li><span class="hllb">%USERPROFILE%\\Documents\\Dolphin Emulator\\Logs</span></li><li>🐧 <span class="hllb">$XDG_DATA_HOME/dolphin-emu/Logs</span></li></ul></span>`,
