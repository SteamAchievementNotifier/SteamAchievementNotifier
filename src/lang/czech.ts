export const translations = {
    ...
    tooltips: {
        ...
        raui: `Zobrazuje názvy rozpoznaných her RetroAchievements v rozhraní zobrazení hry / v oznamovací oblasti<br><br><span class="ttdesc">Pokud je tato možnost povolena, může dojít k neočekávanému chování rozhraní zobrazení hry / oznamovací oblasti, pokud jsou současně spuštěny hry Steam i RetroAchievements</span>`
    },
    update: {
