export const translations = {
    ...
    tooltips: {
        ...
        duckstation: `Toon Retro Achievements-meldingen voor games die via Duckstation worden geëmuleerd<br><br><span class="ttdesc"><span class="hl">Duckstation > Instellingen > Geavanceerd > Log naar bestand</span> moet ingeschakeld zijn</span>`,
        ...
        duckstationpath: `Stel het pad in naar het logbestand van Duckstation <span class="hl">"duckstation.log"</span><br><br><span class="ttdesc">Bij standaardinstallatie-instellingen wordt <span class="hl">"duckstation.log"</span> opgeslagen in <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
