export const translations = {
    global: {
        ...
        raenablelogsub: [
            ...
            `<details>
                ...
                <div>
                    <span class="hl">PCSX2 > Tools > Enable File Logging</span> moet ingeschakeld zijn
                    <br>
                    <br>
    ...
    tooltips: {
        ...
        pcsx2: `Toon Retro Achievements-meldingen voor games die worden geëmuleerd via PCSX2 [Nightly]<br><br><span class="ttdesc"><span class="hl">PCSX2 > Tools > Enable File Logging</span> moet ingeschakeld zijn</span><br><br><span class="ttdesc">❗ Vanwege recente updates is de inhoud van <span class="hl">"emulog.txt"</span> momenteel alleen toegankelijk in de Nightly-versie van PCSX2</span>`,
