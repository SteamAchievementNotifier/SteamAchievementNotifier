export const translations = {
    ...
    tooltips: {
        ...
        rapercenttype: "Set whether to display unlock percentages for Hardcore or Softcore achievements",
        retroarchpath: "Set the path to the root directory of Retroarch",
        dolphinpath: "Set the path to the root directory of Dolphin",
        pcsx2path: "Set the path to the root directory of PCSX2",
    },
    update: {
