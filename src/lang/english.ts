export const translations = {
    ...
    tooltips: {
        ...
        retroarchpath: `Set the path to the folder containing the "Logs" directory for Retroarch`,
        dolphinpath: `Set the path to the folder containing the "Logs" directory for Dolphin`,
        pcsx2path: `Set the path to the folder containing the "Logs" directory for PCSX2`,
    },
    update: {
