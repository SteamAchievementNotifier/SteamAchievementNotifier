export const translations = {
    ...
    settings: {
        ...
        games: {
            ...
            content: {
                ...
                autoreleasegames: "Auto-Release Games",
    ...
    tooltips: {
        ...
        linkedgames: `Bypass <span class="hl">SANWatcher</span> for specific Steam games<br><br><span class="ttdesc">This option should only be used for very specific scenarios. Users should not need to use this option under normal circumstances!</span>`,
        autoreleasegames: `Bypass <span class="hl">automatic process tracking</span> for specific Steam games<br><br><span class="ttdesc">This option should only be used for very specific scenarios. Users should not need to use this option under normal circumstances!</span>`,
