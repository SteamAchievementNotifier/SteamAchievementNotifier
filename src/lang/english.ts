export const translations = {
    global: {
        ...
        raenablelogsub: [
            ...
            `<details>
                ...
                <div>
                    <span class="hl">Duckstation > Settings > Advanced > Log to File</span> must be enabled
                    <br>
                    <br>
                    Using default installation settings, <span class="hl">"duckstation.log"</span> is stored in:
                    <br>
                    <ul>
    ...
    tooltips: {
        ...
        duckstation: `Display Retro Achievements notifications for games emulated via Duckstation<br><br><span class="ttdesc"><span class="hl">Duckstation > Settings > Advanced > Log to File</span> must be enabled</span>`,
        ...
        duckstationpath: `Set the path to Duckstation's <span class="hl">"duckstation.log"</span> log file<br><br><span class="ttdesc">Using default installation settings, <span class="hl">"duckstation.log"</span> is stored in <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
