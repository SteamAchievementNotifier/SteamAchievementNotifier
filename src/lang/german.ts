export const translations = {
    ...
    tooltips: {
        ...
        duckstation: `Retro Achievements-Benachrichtigungen für Spiele anzeigen, die über Duckstation emuliert werden<br><br><span class="ttdesc"><span class="hl">Duckstation > Einstellungen > Erweitert > In Datei protokollieren</span> muss aktiviert sein</span>`,
        ...
        duckstationpath: `Pfad zur Logdatei von Duckstation <span class="hl">"duckstation.log"</span> festlegen<br><br><span class="ttdesc">Bei Standardeinstellungen wird <span class="hl">"duckstation.log"</span> gespeichert unter <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
