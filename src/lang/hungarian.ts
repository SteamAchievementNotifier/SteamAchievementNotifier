export const translations = {
    ...
    tooltips: {
        ...
        raui: `Az észlelt RetroAchievements játékok nevének megjelenítése a Játékkijelző/rendszertálca felhasználói felületén<br><br><span class="ttdesc">Ha engedélyezve van, a Játékkijelző/rendszertálca felhasználói felületének működése váratlan lehet, ha a Steam és a RetroAchievements játékok egyszerre futnak</span>`
    },
    update: {
