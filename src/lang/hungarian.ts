export const translations = {
    ...
    tooltips: {
        ...
        duckstation: `Retro Achievements értesítések megjelenítése Duckstation segítségével emulált játékokhoz<br><br><span class="ttdesc"><span class="hl">Duckstation > Beállítások > Fejlett > Naplózás fájlba</span> engedélyezve kell lennie</span>`,
        ...
        duckstationpath: `A Duckstation naplófájlának elérési útvonalának beállítása <span class="hl">"duckstation.log"</span><br><br><span class="ttdesc">Alapértelmezett telepítési beállításokkal a <span class="hl">"duckstation.log"</span> a következő helyen kerül mentésre <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
