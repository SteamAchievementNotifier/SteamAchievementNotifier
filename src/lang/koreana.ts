export const translations = {
    global: {
        ...
        raenablelogsub: [
            ...
            `<details>
                ...
                <div>
                    <span class="hl">PCSX2 > Tools > Enable File Logging</span>가 활성화되어야 합니다
                    <br>
                    <br>
    ...
    tooltips: {
        ...
        glowcolorbronze: "잠금 해제 비율이 > 50%일 때 표시되는 빛 색상",
        glowcolorsilver: "잠금 해제 비율이 < 50%이고 > $rarity일 때 표시되는 빛 색상",
        ...
        webhookembedcolormain: "메인 성공이 해제될 때 webhook 임베드에 사용될 색상을 설정합니다",
        webhookembedcolorrare: "레어 성공이 해제될 때 webhook 임베드에 사용될 색상을 설정합니다",
        ...
        pcsx2: `PCSX2 [Nightly]로 에뮬레이션된 게임의 Retro Achievements 알림을 표시합니다<br><br><span class="ttdesc"><span class="hl">PCSX2 > Tools > Enable File Logging</span>가 활성화되어야 합니다</span><br><br><span class="ttdesc">❗ 최신 업데이트로 인해 <span class="hl">"emulog.txt"</span>의 내용은 현재 PCSX2의 Nightly 버전에서만 접근할 수 있습니다</span>`,
