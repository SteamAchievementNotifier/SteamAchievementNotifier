export const translations = {
    ...
    tooltips: {
        ...
        duckstation: `Wyświetlaj powiadomienia Retro Achievements dla gier emulowanych przez Duckstation<br><br><span class="ttdesc"><span class="hl">Duckstation > Ustawienia > Zaawansowane > Rejestruj do pliku</span> musi być włączone</span>`,
        ...
        duckstationpath: `Ustaw ścieżkę do pliku logu Duckstation <span class="hl">"duckstation.log"</span><br><br><span class="ttdesc">Przy domyślnych ustawieniach instalacji, <span class="hl">"duckstation.log"</span> jest przechowywane w <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
