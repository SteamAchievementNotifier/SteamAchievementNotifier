export const translations = {
    ...
    tooltips: {
        ...
        raui: `Wyświetlaj nazwy wykrytych gier RetroAchievements w interfejsie wyświetlania gry/obszarze powiadomień systemowych<br><br><span class="ttdesc">Po włączeniu mogą wystąpić nieoczekiwane zachowania interfejsu wyświetlania gry/obszaru powiadomień systemowych, jeśli gry Steam i RetroAchievements są uruchomione jednocześnie</span>`
    },
    update: {
