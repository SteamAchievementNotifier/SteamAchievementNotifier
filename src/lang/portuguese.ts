export const translations = {
    ...
    tooltips: {
        ...
        raui: `Exibe os nomes dos jogos RetroAchievements detetados na Interface de Exibição do Jogo/área de notificação do sistema<br><br><span class="ttdesc">Quando ativado, poderá ocorrer um comportamento inesperado da Interface de Exibição do Jogo/área de notificação do sistema se os jogos Steam e RetroAchievements estiverem a ser executados em simultâneo</span>`
    },
    update: {
