export const translations = {
    ...
    tooltips: {
        ...
        duckstation: `Mostrar notificaciones de Retro Achievements para juegos emulados a través de Duckstation<br><br><span class="ttdesc"><span class="hl">Duckstation > Configuración > Avanzado > Registrar en archivo</span> debe estar habilitado</span>`,
        ...
        duckstationpath: `Establecer la ruta del archivo de registro de Duckstation <span class="hl">"duckstation.log"</span><br><br><span class="ttdesc">Con la configuración de instalación predeterminada, <span class="hl">"duckstation.log"</span> se guarda en <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
