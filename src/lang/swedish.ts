export const translations = {
    ...
    tooltips: {
        ...
        raui: `Visa namnen på upptäckta RetroAchievements-spel i spelvisningsgränssnittet/systemfältets användargränssnitt<br><br><span class="ttdesc">När detta är aktiverat kan oväntat beteende uppstå i spelvisningsgränssnittet/systemfältets användargränssnitt om både Steam- och RetroAchievements-spel körs samtidigt</span>`
    },
    update: {
