export const translations = {
    global: {
        ...
        raenablelogsub: [
            ...
            `<details>
                ...
                <div>
                    <span class="hl">Duckstation > Inställningar > Avancerat > Logga till fil</span> måste vara aktiverat
                    <br>
                    <br>
                    Med standardinstallationsinställningar sparas <span class="hl">"duckstation.log"</span> på följande plats:
                    <br>
                    <ul>
    ...
    tooltips: {
        ...
        duckstation: `Visa Retro Achievements-notifikationer för spel som emuleras via Duckstation<br><br><span class="ttdesc"><span class="hl">Duckstation > Inställningar > Avancerat > Logga till fil</span> måste vara aktiverat</span>`,
        ...
        duckstationpath: `Ställ in sökvägen till Duckstations loggfil <span class="hl">"duckstation.log"</span><br><br><span class="ttdesc">Med standardinstallationsinställningar sparas <span class="hl">"duckstation.log"</span> på <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
