export const translations = {
    ...
    tooltips: {
        ...
        retroarchpath: `ตั้งค่าเส้นทางของไฟล์บันทึก <span class="hl">"retroarch.log"</span> ของ RetroArch<br><br><span class="ttdesc">เมื่อใช้การตั้งค่าการติดตั้งเริ่มต้น, <span class="hl">"retroarch.log"</span> จะถูกเก็บไว้ที่ <span class="hllb">C:\\RetroArch-x64\\Logs</span></span>`,
