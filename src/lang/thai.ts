export const translations = {
    global: {
        ...
        raenablelogsub: [
            ...
            `<details>
                ...
                <div>
                    <span class="hl">Duckstation > การตั้งค่า > ขั้นสูง > บันทึกลงไฟล์</span> ต้องเปิดใช้งาน
                    <br>
                    <br>
                    โดยใช้การตั้งค่าการติดตั้งเริ่มต้น, <span class="hl">"duckstation.log"</span> จะถูกบันทึกใน:
                    <br>
                    <ul>
    ...
    customiser: {
        ...
        icons: {
            ...
            content: {
                ...
                iconborderimgbronze: "ความหายาก > 50%",
                iconborderimgsilver: "ความหายาก: < 50% และ > $rarity",
                front: "ด้านหน้า",
                back: "ด้านหลัง",
                plat: "โลโก้ 100%",
    ...
    tooltips: {
        ...
        iconborderimgbronze: "ภาพกรอบไอคอนที่แสดงเมื่อเปอร์เซ็นต์การปลดล็อก > 50%",
        iconborderimgsilver: "ภาพกรอบไอคอนที่แสดงเมื่อเปอร์เซ็นต์การปลดล็อก < 50% และ > $rarity",
        ...
        rakey: `ตั้งค่า Web API Key ที่จะใช้ในการตรวจสอบสิทธิ์กับ Retro Achievements API<br><br><span class="ttdesc">คุณสามารถคัดลอกหรือสร้าง Web API Key ใหม่ได้โดยการเข้าสู่ระบบเว็บไซต์ Retro Achievements และไปที่ <span class="hl">การตั้งค่า > คีย์ > Web API Key</span><br><br>🔒 คีย์ที่ให้จะถูกเข้ารหัสก่อนที่จะถูกเก็บไว้ในระบบท้องถิ่น</span>`,
        ...
        pcsx2: `แสดงการแจ้งเตือน Retro Achievements สำหรับเกมที่จำลองโดย PCSX2 [Nightly]<br><br><span class="ttdesc"><span class="hl">PCSX2 > เครื่องมือ > เปิดใช้งานการบันทึกไฟล์</span> ต้องเปิดใช้งาน</span><br><br><span class="ttdesc">❗ เนื่องจากการอัปเดตล่าสุด, เนื้อหาของ <span class="hl">"emulog.txt"</span> สามารถเข้าถึงได้เฉพาะในเวอร์ชัน Nightly ของ PCSX2 เท่านั้น</span>`,
        duckstation: `แสดงการแจ้งเตือน Retro Achievements สำหรับเกมที่จำลองโดยใช้ Duckstation<br><br><span class="ttdesc"><span class="hl">Duckstation > การตั้งค่า > ขั้นสูง > บันทึกลงไฟล์</span> ต้องเปิดใช้งาน</span>`,
        ...
        duckstationpath: `ตั้งค่าพาธไปยังไฟล์บันทึกของ Duckstation <span class="hl">"duckstation.log"</span><br><br><span class="ttdesc">โดยใช้การตั้งค่าการติดตั้งเริ่มต้น, <span class="hl">"duckstation.log"</span> จะถูกบันทึกใน <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
        ...
        ssmode: `ตั้งค่าว่าควรจับภาพทั้งหน้าจอหรือแค่หน้าต่างเกมปัจจุบัน<span style="color: red;">*</span> ในการจับภาพหน้าจอ<br><br><span class="ttdesc">หากไม่สามารถหาพบ <span class="hl">ไฟล์โปรแกรม</span> ของเกมปัจจุบันได้ (<i>ไม่ว่าจะผ่าน <span class="hl">การติดตามกระบวนการอัตโนมัติ</span> หรือการเพิ่มเป็น <span class="hl">เกมที่เชื่อมโยง</span></i>) ตัวเลือกนี้จะตั้งค่าเป็นโหมด "หน้าจอ" โดยอัตโนมัติ</span>` ,
