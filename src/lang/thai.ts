export const translations = {
    global: {
        ...
        missingdepssub: [
            `ดูเหมือนว่าคุณกำลังพยายามเปิดใช้งานตัวเลือก <span class="hl"> ถ่ายภาพหน้าจอ Steam </span> อยู่ อย่างไรก็ตาม ใน Linux การถ่ายภาพหน้าจอไม่สามารถเรียกใช้โดยอัตโนมัติได้โดยไม่ติดตั้งแพ็คเกจ <code class="dialogcode"> xdotool </code> ก่อน`,
            `โปรดรัน <code class="dialogcode" style="user-select: text;"> sudo apt-get install xdotool </code> เพื่อติดตั้งการขึ้นอยู่กับนี้ ทำให้ Steam สามารถถ่ายภาพหน้าจอได้ในอุปกรณ์นี้`
        ],
