export const translations = {
    global: {
        ...
        raenablelogsub: [
            ...
            `<details>
                ...
                <div>
                    <span class="hl">PCSX2 > Tools > Enable File Logging</span> ต้องเปิดใช้งาน
                    <br>
                    <br>
    ...
    tooltips: {
        ...
        pcsx2: `แสดงการแจ้งเตือน Retro Achievements สำหรับเกมที่จำลองโดย PCSX2 [Nightly]<br><br><span class="ttdesc"><span class="hl">PCSX2 > Tools > Enable File Logging</span> ต้องเปิดใช้งาน</span><br><br><span class="ttdesc">❗ เนื่องจากการอัปเดตล่าสุด, เนื้อหาของ <span class="hl">"emulog.txt"</span> สามารถเข้าถึงได้เฉพาะในเวอร์ชัน Nightly ของ PCSX2 เท่านั้น</span>`,
