export const translations = {
    ...
    settings: {
        ...
        notifications: {
            ...
            content: {
                ...
                testnotifycustomtext: "ข้อความกำหนดเองของการแจ้งเตือนทดสอบ",
                testnotifycustomtexttitle: "ชื่อเรื่อง",
                testnotifycustomtextdesc: "คำอธิบาย"
            }
        },
        games: {
            title: "เกม",
        ...
        advanced: {
            ...
            content: {
                ...
                workerdebug: "แสดง DevTools ของ Worker",
                ...
                logresourceusage: "บันทึกการใช้ทรัพยากร"
            }
        },
        ra: {
    ...
    customiser: {
        preset: {
            ...
            content: {
                ...
                usecustomtext: "ข้อความกำหนดเอง",
                customtextunlockmsg: "ข้อความปลดล็อก",
                customtexttitle: "ชื่อความสำเร็จ",
                customtextdesc: "คำอธิบายความสำเร็จ"
            }
        },
        sound: {
            title: "เสียง",
    ...
    tooltips: {
        ...
        workerdebug: "สร้างหน้าต่าง DevTools สำหรับกระบวนการ Worker มีประโยชน์สำหรับการดีบักและแก้ไขปัญหาการติดตามเกม",
        ...
        logresourceusage: `บันทึกสถิติการใช้ทรัพยากรของแอป/ระบบเมื่อการแจ้งเตือนความสำเร็จถูกเรียกใช้<br><br><span class="ttdesc">สามารถใช้เพื่อระบุว่าปัญหาบางอย่างภายในแอปอาจเกิดจากภาระโหลดโดยรวมของระบบขณะปลดล็อกความสำเร็จหรือไม่</span>`,
        decorationshadow: "กำหนดว่าจะใช้เงาของแบบอักษรกับองค์ประกอบตกแต่งด้วยหรือไม่",
        uimode: `เลือกจำนวนตัวเลือกที่แสดงในเมนูการตั้งค่า/การปรับแต่ง<br><br><span class="ttdesc" nostar><ul><li><span class="hl">พื้นฐาน</span>: แสดงเฉพาะตัวเลือกส่วนติดต่อผู้ใช้ที่ใช้งานง่ายในจำนวนจำกัด</li><li><span class="hl">ขั้นสูง</span>: แสดงตัวเลือกส่วนติดต่อผู้ใช้ทั้งหมดที่มี</li></ul></span>`,
        usecustomtext: "กำหนดข้อความที่กำหนดเองให้แสดงภายในการแจ้งเตือน",
        customtextunlockmsg: `กำหนดข้อความที่กำหนดเองให้แสดงภายในองค์ประกอบข้อความปลดล็อก<br><br><span class="ttdesc">ตัวเลือกนี้จะถูกซ่อนเมื่อ การปรับแต่ง > ค่าที่ตั้งไว้ > องค์ประกอบการแจ้งเตือน > ข้อความปลดล็อก ถูกปิดใช้งาน</span>`,
        customtexttitle: `กำหนดข้อความที่กำหนดเองให้แสดงภายในองค์ประกอบชื่อความสำเร็จ<br><br><span class="ttdesc">ตัวเลือกนี้จะถูกซ่อนเมื่อ การปรับแต่ง > ค่าที่ตั้งไว้ > องค์ประกอบการแจ้งเตือน > ชื่อความสำเร็จ ถูกปิดใช้งาน</span>`,
        customtextdesc: `กำหนดข้อความที่กำหนดเองให้แสดงภายในองค์ประกอบคำอธิบายความสำเร็จ<br><br><span class="ttdesc">ตัวเลือกนี้จะถูกซ่อนเมื่อ การปรับแต่ง > ค่าที่ตั้งไว้ > องค์ประกอบการแจ้งเตือน > คำอธิบายความสำเร็จ ถูกปิดใช้งาน</span>`
    },
    update: {
    ...
    themeswitch: {
        content: {
            ...
            radefault: "ตั้งเป็นค่าเริ่มต้นสำหรับ RetroAchievements"
        }
    },
    troubleshooter: {
        title: "แก้ไขปัญหา",
        content: {
            copydata: "คัดลอก",
            noissues: "ไม่พบปัญหา!",
            noissuessub: "เกมนี้ควรเปิดใช้งานโดยอัตโนมัติ",
            manualrelease: `คุณสามารถเปิดใช้งานเกมใดก็ได้ด้วยตนเองผ่าน <span class="hl">ถาดระบบ</span> > <span class="hl">ตัวเลือก</span> > <span class="hl">เปิดใช้งานเกม</span>`,
            addedvia: "เพิ่มผ่าน"
        },
        rules: {
            noactiveprocesses: {
                title: "ไม่มีกระบวนการที่ทำงานอยู่",
                issue: "ไม่พบกระบวนการของเกมที่กำลังทำงานอยู่",
                detail: "ไม่พบไฟล์ปฏิบัติการที่เชื่อมโยงกับเกมนี้เป็นกระบวนการที่กำลังทำงานอยู่ ตรวจสอบไฟล์ปฏิบัติการต่อไปนี้แล้ว:",
                solution: [
                    `ลองเพิ่มไฟล์ปฏิบัติการของเกมไปยัง $linkedgamesmenu`,
                    `ตรวจสอบให้แน่ใจว่ารายการใน $linkedgamesmenu ชี้ไปยังไฟล์ปฏิบัติการที่ถูกต้อง`
                ]
            },
            unknownexecutable: {
                title: "ไม่ทราบไฟล์ปฏิบัติการ",
                issue: "ไม่สามารถระบุไฟล์ปฏิบัติการของเกมได้",
                detail: "ไม่สามารถค้นหาเส้นทางไปยังไฟล์ปฏิบัติการของเกมโดยอัตโนมัติ ซึ่งมักเกิดจากตัวเปิดเกมที่ทำงานก่อนเริ่มเกมเมื่อเปิดเกมผ่าน Steam",
                solution: [
                    `เพิ่มรายการใหม่สำหรับเกมนี้ไปยัง $linkedgamesmenu หรือลบรายการใด ๆ ที่ชี้ไปยังไฟล์ปฏิบัติการของเกมที่ไม่ถูกต้อง หรือมิฉะนั้น ให้ตรวจสอบว่าเกมรองรับตัวเลือกการเปิดเกมของ Steam เพื่อข้ามตัวเปิดเกมที่ทำงานก่อนเริ่มเกมหรือไม่ เช่น <code style="font-size: 0.55rem;">-skiplauncher</code>`,
                    `ลองเปิดใช้งาน $sanwatcher`
                ]
            },
            missingexecutable: {
                title: "ไม่พบไฟล์ปฏิบัติการ",
                issue: "ไม่พบไฟล์ปฏิบัติการของเกมบนดิสก์",
                detail: `ไม่พบไฟล์ปฏิบัติการที่เชื่อมโยงกับเกมนี้บนดิสก์ ตรวจสอบไฟล์ปฏิบัติการต่อไปนี้แล้ว:`,
                solution: ["ลองตรวจสอบความสมบูรณ์ของไฟล์เกมผ่าน Steam หรือติดตั้งเกมใหม่"]
            },
            notexecutable: {
                title: "ไม่สามารถเรียกใช้งานได้",
                issue: `เกมไม่มีสิทธิ์ในการเรียกใช้งาน`,
                detail: "ไม่สามารถเรียกใช้งานไฟล์ที่ Steam ใช้เปิดเกมได้ ไฟล์ดังกล่าวถูกรายงานว่า:",
                solution: ["หากต้องการทำให้ไฟล์นี้สามารถเรียกใช้งานได้ โปรดดูคำแนะนำสำหรับ Linux ดิสทริบิวชันที่คุณใช้งาน"]
            },
            notwithininstalldir: {
                title: "ไม่ได้อยู่ในไดเรกทอรีของเกม",
                issue: "ไฟล์ปฏิบัติการไม่ได้อยู่ในไดเรกทอรีติดตั้ง",
                detail: "ตรวจพบรายการสำหรับเกมนี้ภายใต้ $linkedgamesmenu แต่ไฟล์ปฏิบัติการที่เชื่อมโยงไม่ได้อยู่ภายในโฟลเดอร์ติดตั้งของเกม ซึ่งอาจหมายความว่าไฟล์ดังกล่าวไม่ใช่ไฟล์ที่ถูกต้อง",
                solution: ["แก้ไขรายการ $linkedgamesmenu สำหรับเกมนี้และตรวจสอบให้แน่ใจว่ารายการชี้ไปยังไฟล์ปฏิบัติการของเกมที่ถูกต้อง"]
            },
            wrongplatformpath: {
                title: "เส้นทางเกมไม่ถูกต้อง",
                issue: "เส้นทางเกมไม่ถูกต้องสำหรับระบบปฏิบัติการปัจจุบัน",
                detail: "เส้นทางไฟล์ปฏิบัติการของเกมนี้ดูเหมือนจะเป็นของระบบปฏิบัติการอื่น ซึ่งอาจเกิดจากการคัดลอกการกำหนดค่าจากคอมพิวเตอร์เครื่องอื่นหรือการตั้งค่าระบบดูอัลบูต",
                solution: [`อย่าใช้การกำหนดค่าที่คัดลอกมาจากคอมพิวเตอร์/ระบบปฏิบัติการเครื่องอื่น เนื่องจากอาจทำงานได้ไม่เป็นไปตามที่คาดไว้ <span class="hl">ธีม</span> ที่มีอยู่ทั้งหมดสามารถนำเข้า/ส่งออกข้ามแพลตฟอร์มได้ผ่านเมนู <span class="hl">ตัวปรับแต่ง</span>`]
            },
            duplicatelinkentries: {
                title: "รายการซ้ำ",
                issue: "พบรายการ $linkedgamesmenu ที่ซ้ำกัน",
                detail: "ไฟล์ปฏิบัติการของเกมนี้ยังเชื่อมโยงกับ $appids ภายใต้ $linkedgamesmenu",
                solution: ["ลบรายการที่ซ้ำกันรายการหนึ่งและตรวจสอบให้แน่ใจว่ารายการที่เหลือชี้ไปยังไฟล์ปฏิบัติการของเกมที่ถูกต้อง"]
            },
            releasing: {
                title: "กำลังเปิดเกม",
                issue: "เกมกำลังเปิด",
                detail: "เกมนี้กำลังจะเปิด",
                solution: [`โปรดรออีกสักครู่ — จุดบนไอคอน <span class="hl">ถาดระบบ</span> จะเปลี่ยนจาก <span class="troubleshooterdialogicon" grey></span> (กำลังเปิด) เป็น <span class="troubleshooterdialogicon" red></span> (ไม่ได้ใช้งาน) เมื่อเกมเปิดแล้ว`]
            }
        }
    }
}
