export const translations = {
    global: {
        ...
        raenablelog: `เปิดใช้งานไฟล์บันทึกของอีมูเลเตอร์`,
        raenablelogsub: [
            `เพื่อเข้าถึงเหตุการณ์ภายในสำหรับอีมูเลเตอร์ที่รองรับ (เช่น สถานะเกมปัจจุบัน, ข้อมูลการปลดล็อกความสำเร็จ ฯลฯ) จำเป็นต้องเปิดใช้งาน <span class="hl">ไฟล์บันทึก</span> ในอีมูเลเตอร์ที่เลือกไว้<br><br>ไฟล์บันทึกแต่ละไฟล์จะอยู่ในโฟลเดอร์ <span class="hl">Logs</span> ภายในไดเรกทอรีที่กำหนดสำหรับแต่ละอีมูเลเตอร์ที่เลือก`,
            `<span class="hl">RetroArch</span>: ไปที่ <i class="hllb">การตั้งค่า > การบันทึก</i> และตั้งค่า <i><span class="hllb">ความละเอียดของการบันทึก</span>: <span class="hlgreen">เปิด</span>, <span class="hllb">ระดับการบันทึกของหน้าต่าง</span>: <span class="hlgreen">1 (ข้อมูล)</span></i> และ <i><span class="hllb">บันทึกลงในไฟล์</span>: <span class="hlgreen">เปิด</span></i>`,
            `<span class="hl">Dolphin</span>: ไปที่ <i class="hllb">มุมมอง > แสดงการตั้งค่าการบันทึก</i> และตั้งค่า <i><span class="hllb">ความละเอียด</span>: <span class="hlgreen">ข้อมูล</span>, <span class="hllb">ผลลัพธ์ของบันทึก</span> > <span class="hlgreen">เขียนลงไฟล์</span></i> และ <i><span class="hllb">ประเภทของการบันทึก</span> > <span class="hlgreen">ความสำเร็จ (RetroAchievements)</span></i>`,
            `<span class="hl">PCSX2</span>: ติ๊กเลือก <i class="hllb">เครื่องมือ > เปิดใช้งานการบันทึกไฟล์</i>`
        ]
    },
    app: {
        content: {
    ...
    settings: {
        ...
        ra: {
            ...
            content: {
                ...
                pcsx2: "PCSX2",
                ppspp: "PPSPP",
                installdir: "เส้นทางข้อมูล",
                rapercenttype: "ประเภทเปอร์เซ็นต์",
                hard: "Hardcore",
                soft: "Softcore",
                placeholder: "กรอกเส้นทางการติดตั้ง"
            }
        },
        misc: {
            title: "เบ็ดเตล็ด",
    ...
    customiser: {
        ...
        style: {
            ...
            content: {
                ...
                glowcolorbronze: "ความหายาก: > 50%",
                glowcolorsilver: "ความหายาก: < 50% & > $rarity",
    ...
    tooltips: {
        ...
        glowcolorbronze: "สีของการเรืองแสงที่แสดงเมื่อเปอร์เซ็นต์การปลดล็อก > 50%",
        glowcolorsilver: "สีของการเรืองแสงที่แสดงเมื่อเปอร์เซ็นต์การปลดล็อก < 50% และ > $rarity",
        ...
        webhookmain: `สลับว่าจะแสดงข้อมูลการปลดล็อกความสำเร็จหลักใน Discord เซิร์ฟเวอร์หรือไม่`,
        webhookrare: "สลับว่าจะแสดงข้อมูลการปลดล็อกความสำเร็จหายากใน Discord เซิร์ฟเวอร์หรือไม่",
        webhookplat: "สลับว่าจะแสดงข้อมูลการปลดล็อกความสำเร็จ 100% ใน Discord เซิร์ฟเวอร์หรือไม่",
        ...
        webhookembedcolormain: "ตั้งค่าสีที่ใช้ใน webhook เมื่อปลดล็อคความสำเร็จหลัก",
        webhookembedcolorrare: "ตั้งค่าสีที่ใช้ใน webhook เมื่อปลดล็อคความสำเร็จหายาก",
        webhookembedcolorplat: "ตั้งค่าสีที่ใช้ใน webhook เมื่อปลดล็อคความสำเร็จ 100%",
        ...
        rakey: `ตั้งค่า Web API Key ที่ใช้ในการยืนยันตัวตนกับ Retro Achievements API<br><br><span class="ttdesc">สามารถคัดลอกหรือสร้าง Web API Key ใหม่ได้โดยการเข้าสู่ระบบในเว็บไซต์ Retro Achievements และไปที่ การตั้งค่า > คีย์ > Web API Key<br><br>🔒 คีย์ที่ให้ไว้จะถูกเข้ารหัสก่อนที่มันจะถูกจัดเก็บในเครื่อง</span>`,
        rapercenttype: "ตั้งค่าการแสดงเปอร์เซ็นต์การปลดล็อกความสำเร็จแบบ Hardcore หรือ Softcore ในการแจ้งเตือน",
        retroarch: `แสดงการแจ้งเตือน Retro Achievements สำหรับเกมที่จำลองผ่าน RetroArch<br><br><span class="ttdesc"><i class="hllb">RetroArch > การตั้งค่า > การบันทึก</i> ต้องตั้งค่าด้วยการตั้งค่าต่อไปนี้:<br><br><ul><li><span class="hllb">ความละเอียดของการบันทึก</span>: <span class="hlgreen">เปิด</span></li><li><span class="hllb">ระดับการบันทึกส่วนหน้า</span>: <span class="hlgreen">1 (ข้อมูล)</span></li><li><span class="hllb">บันทึกลงไฟล์</span>: <span class="hlgreen">เปิด</span></li></ul></span>`,  
        dolphin: `แสดงการแจ้งเตือน Retro Achievements สำหรับเกมที่จำลองผ่าน Dolphin<br><br><span class="ttdesc"><i class="hllb">Dolphin > มุมมอง > แสดงการตั้งค่าการบันทึก</i> ต้องตั้งค่าด้วยการตั้งค่าต่อไปนี้:<br><br><ul><li><span class="hllb">ความละเอียด</span>: <span class="hlgreen">ข้อมูล</span></li><li><span class="hllb">ผลลัพธ์ของการบันทึก</span> > <span class="hlgreen">เขียนลงไฟล์</span></li><li><span class="hllb">ประเภทของการบันทึก</span> > <span class="hlgreen">ความสำเร็จ (RetroAchievements)</span></li></ul></span>`,  
        pcsx2: `แสดงการแจ้งเตือน Retro Achievements สำหรับเกมที่จำลองผ่าน PCSX2<br><br><span class="ttdesc"><i class="hllb">PCSX2 > เครื่องมือ > เปิดการบันทึกไฟล์</i> ต้องเปิดใช้งาน</span>`,  
        retroarchpath: `ตั้งค่าพาธไปยังโฟลเดอร์ที่มีไดเรกทอรี "Logs" สำหรับ RetroArch<br><br><span class="ttdesc">ข้อมูลของ RetroArch จะถูกเก็บในไดเรกทอรีการติดตั้งแอป</span>`,  
        dolphinpath: `ตั้งค่าพาธไปยังโฟลเดอร์ที่มีไดเรกทอรี "Logs" สำหรับ Dolphin<br><br><span class="ttdesc">ข้อมูลของ Dolphin จะถูกเก็บในตำแหน่งใดตำแหน่งหนึ่งต่อไปนี้:<br><br><ul><li><span class="hllb">%APPDATA%\\Dolphin Emulator</span></li><li><span class="hllb">%USERPROFILE%\\Documents\\Dolphin Emulator</span></li><li>🐧 <span class="hllb">$XDG_DATA_HOME/dolphin-emu</span></li></ul></span>`,  
        pcsx2path: `ตั้งค่าพาธไปยังโฟลเดอร์ที่มีไดเรกทอรี "Logs" สำหรับ PCSX2<br><br><span class="ttdesc">ข้อมูลของ PCSX2 จะถูกเก็บในไดเรกทอรีการติดตั้งแอป</span>`,
    },
    update: {
