export const translations = {
    ...
    tooltips: {
        ...
        duckstation: `Duckstation ile taklit edilen oyunlar için Retro Achievements bildirimlerini göster<br><br><span class="ttdesc"><span class="hl">Duckstation > Ayarlar > Gelişmiş > Dosyaya Kayıt</span> etkinleştirilmiş olmalıdır</span>`,
        ...
        duckstationpath: `Duckstation'un <span class="hl">"duckstation.log"</span> dosyasının yolunu ayarlayın<br><br><span class="ttdesc">Varsayılan kurulum ayarlarıyla, <span class="hl">"duckstation.log"</span> şu konumda saklanır <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
