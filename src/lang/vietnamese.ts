export const translations = {
    ...
    tooltips: {
        ...
        pcsx2: `Hiển thị thông báo Retro Achievements cho các trò chơi được giả lập qua PCSX2 [Nightly]<br><br><span class="ttdesc"><span class="hl">PCSX2 > Công cụ > Bật ghi vào file</span> phải được bật</span><br><br><span class="ttdesc">❗ Do các bản cập nhật gần đây, nội dung của <span class="hl">"emulog.txt"</span> hiện chỉ có thể truy cập trong phiên bản Nightly của PCSX2</span>`,
        duckstation: `Hiển thị thông báo Retro Achievements cho các trò chơi giả lập qua Duckstation<br><br><span class="ttdesc"><span class="hl">Duckstation > Cài đặt > Nâng cao > Ghi vào file</span> phải được bật</span>`,
        ...
        duckstationpath: `Đặt đường dẫn đến file nhật ký của Duckstation <span class="hl">"duckstation.log"</span><br><br><span class="ttdesc">Với cài đặt mặc định, <span class="hl">"duckstation.log"</span> sẽ được lưu ở <span class="hllb">%USERPROFILE%\\Documents\\Duckstation</span></span>`,
