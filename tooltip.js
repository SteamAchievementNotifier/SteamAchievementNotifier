...
function LoadLangTT() {
   const configtt = JSON.parse(fstt.readFileSync(pathtt.join(process.env.LOCALAPPDATA,"Steam Achievement Notifier (V1.8)","store","config.json")));
   ...
   if (configtt.lang == "english") {
      ...
      steam64lbltt = 'Click here to get your Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Save";
      ...
      steam64lbltt = "انقر هنا للحصول على Steam64ID الخاص بك <img src='./icons/open_in_new.svg' width='12px' style='vertical-align: -3px'>";
      savett = "حفظ باسم";
      ...
      steam64lbltt = 'Щракнете тук за да получите своя Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Запазете";
      ...
      steam64lbltt = '单击此处获取您的 Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "节省";
      ...
      steam64lbltt = '單擊此處獲取您的 Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "節省";
      ...
      steam64lbltt = 'Klikněte sem a získejte Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Uložit";
      ...
      steam64lbltt = 'Klik her for at få din Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Gemme";
      ...
      steam64lbltt = 'Klik hier om je Steam64ID te krijgen <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Opslaan";
      ...
      steam64lbltt = 'Cliquez ici pour obtenir votre Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Sauvegarder";
      ...
      steam64lbltt = 'Klicken Sie hier um Ihre Steam64ID zu erhalten <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Speichern";
      ...
      steam64lbltt = 'Κάντε κλικ εδώ για να λάβετε το Steam64ID σας <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Σώσει";
      ...
      steam64lbltt = 'Kattintson ide a Steam64ID beszerzéséhez <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Megment";
      ...
      steam64lbltt = 'Clicca qui per ottenere il tuo Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Salva";
      ...
      steam64lbltt = 'Steam64IDを入手するには、ここをクリックしてください <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "保存する";
      ...
      steam64lbltt = 'Steam64ID를 받으려면 여기를 클릭하세요. <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "구하다";
      ...
      steam64lbltt = 'Klikk her for å få din Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Lagre";
      ...
      steam64lbltt = 'Kliknij tutaj aby uzyskać Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Zapisać";
      ...
      steam64lbltt = 'Clique aqui para obter seu Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Salvar";
      ...
      steam64lbltt = 'Haga clic aquí para obtener su Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Salvar";
      ...
      steam64lbltt = 'Klicka här för att få ditt Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Spara";
      ...
      steam64lbltt = 'คลิกที่นี่เพื่อรับ Steam64ID ของคุณ <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "บันทึก";
      ...
      steam64lbltt = 'Натисніть тут щоб отримати свій Steam64ID <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Зберегти";
      ...
      steam64lbltt = 'Nhấp vào đây để tải Steam64ID của bạn <img src="./icons/open_in_new.svg" width="12px" style="vertical-align: -3px">';
      savett = "Lưu Cái Này";
